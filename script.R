...
ui <- dashboardPage(skin="black",
 ...
 #),
    ...
    fluidRow(
      box(width=5, title="Select Model Assumptions",status = 'primary', solidHeader = TRUE,
      column(width=6,
             box(title="Other Assumptions", width=12,
    ...
    column(width=6,
           box(title="Second Homes", width=12,
           ...
           box(title="Short-Term Rentals", width=12,
           ...
           box(title="Hotel/Resort/Casino", width=12,
